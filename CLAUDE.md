...
- `POST http://llmgw.arch.internal/v1/models/validate` — reload the registry (picks up new `ollama pull` models / new provider IDs since boot) + re-run model validation
